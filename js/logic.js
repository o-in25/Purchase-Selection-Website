...
$(function() {
    ...
    function Choice() {
        ...
        /** Function
         *  Increments clicked by a predefined constant
         */
    ...
    function menuSelection(clicked) {
        ...
        else if(dataToggle == COMMUTER)
        {
            ...
            else if(prefixInt < 6 && suffixInt == 6)
            {
                data = "Special Case";
            }
            else
            ...
            console.log(prefixInt + ' ' + suffixInt + ' ' + clicked);
        }
        if(data == "A")
        {
            // Unlimited
